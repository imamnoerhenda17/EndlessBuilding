...
public class GoogleAdMobController : MonoBehaviour
{
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-2157856902117678/7072360604";
#elif UNITY_IPHONE
    ...
    public void RequestAndLoadInterstitialAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-2157856902117678/5430136135";
#elif UNITY_IPHONE
    ...
    public void ShowInterstitialAd()
    {
        ...
        {
            interstitialAd.Show();
            int temp = PlayerPrefs.GetInt("JatahSehari");
            if(temp>0)
            {
                temp-=1;
                PlayerPrefs.SetInt("JatahSehari", temp);
                // Debug.Log(PlayerPrefs.GetInt("JatahSehari"));
            }
        }
    }
